---
title: Polypasswordhasher metadata example
linkTitle: Polypasswordhasher
aliases: [/examples/polypasswordhasher]
# prettier-ignore
cSpell:ignore: polypasswordhasher fastpolymath runtests sdist untar nMIIBojANBgkqhkiG9w0BAQEFAAOCAY8AMIIBigKC RSASSA keyid keytype keyval shamirsecret fastshamirsecret pubkeys
---
    ...
    "steps": [
      ...
      },
      {
        ...
        "expected_materials": [
          ...
          ["MATCH", "setup.py", "WITH", "PRODUCTS", "FROM", "tag-release"],
          ["MATCH", "test/test*.py", "WITH", "PRODUCTS", "FROM", "tag-release"],
          [
            "MATCH",
            "test/__init__.py",
            "WITH",
        ...
        "expected_products": [
          ["CREATE", "dist/PolyPasswordHasher-0.2a0.tar.gz"]
        ]
      },
      {
        "_type": "step",
