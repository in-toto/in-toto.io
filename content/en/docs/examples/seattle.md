---
title: Seattle metadata example
linkTitle: Seattle
aliases: [/examples/seattle]
# prettier-ignore
cSpell:ignore: untar custominstallerbuilder nMIIBojANBgkqhkiG9w0BAQEFAAOCAY8AMIIBigKC RSASSA keyid keytype keyval pubkeys _repy vesselinfo baseaffix canihear advertisepipe advertiseserver
---
    ...
    "steps": [
      {
        ...
        "threshold": 1,
        "expected_materials": [],
        "expected_products": [["CREATE", "installer-packaging/*"]]
      },
      {
        "_type": "step",
        "name": "build-runnable",
    ...
    "inspect": [
      {
        ...
        "expected_materials": [["CREATE", "*"]],
        "expected_products": [
          ["CREATE", "seattle/seattle_repy/vesselinfo"],
          [
            "MATCH",
            "seattle/*",
            "WITH",
