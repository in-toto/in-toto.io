---
title: Debian metadata example
linkTitle: Debian
aliases: [/examples/debian]
# prettier-ignore
cSpell:ignore: dget dpkg RSASSA keyid keytype keyval pubkeys buildpackage nMIIBojANBgkqhkiG9w0BAQEFAAOCAY8AMIIBigKC lukas rgrep dlopen pcre pcresearch gpgv fakeroot
---
  ...
  "signed": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "threshold": 1,
        "expected_materials": [
          ["MATCH", "*", "WITH", "PRODUCTS", "FROM", "extract"]
        ],
        "expected_products": [["ALLOW", "*"]]
      },
      {
        ...
        "threshold": 1,
        "expected_materials": [
          ["MATCH", "*", "WITH", "PRODUCTS", "FROM", "modify"]
        ],
        "expected_products": [["ALLOW", "*"]]
      }
    ],
